...
from agentrules.core.types.models import (
    ...
    OPENROUTER_MINIMAX_M2,
    OPENROUTER_QWEN_3,
    OPENROUTER_GLM_4_7,
    OPENROUTER_GLM_4_6V,
    OPENROUTER_GLM_4_6,
    OPENROUTER_DEEPSEEK_CHAT_V2,
    ZAI_GLM4,
    ZAI_GLM4_PLUS,
    ZAI_GLM4_AIR,
    ZAI_GLM4_AIRX,
...
MODEL_PRESETS: dict[str, PresetDefinition] = {
    ...
    "openrouter-minimax-m2": _preset(
        config=OPENROUTER_MINIMAX_M2,
        label="Minimax M2 (OpenRouter)",
        description="Minimax M2 model via OpenRouter.",
        provider=ModelProvider.OPENROUTER,
    ),
    "openrouter-qwen3": _preset(
        config=OPENROUTER_QWEN_3,
        label="Qwen 3 (OpenRouter)",
        description="Alibaba's Qwen 3 model via OpenRouter.",
        provider=ModelProvider.OPENROUTER,
    ),
    "openrouter-glm-4.7": _preset(
        config=OPENROUTER_GLM_4_7,
        label="GLM-4.7 (OpenRouter)",
        description="Zhipu AI's GLM-4.7 model via OpenRouter.",
        provider=ModelProvider.OPENROUTER,
    ),
    "openrouter-glm-4.6v": _preset(
        config=OPENROUTER_GLM_4_6V,
        label="GLM-4.6v (OpenRouter)",
        description="Zhipu AI's GLM-4.6v model via OpenRouter.",
        provider=ModelProvider.OPENROUTER,
    ),
    "openrouter-glm-4.6": _preset(
        config=OPENROUTER_GLM_4_6,
        label="GLM-4.6 (OpenRouter)",
        description="Zhipu AI's GLM-4.6 model via OpenRouter.",
        provider=ModelProvider.OPENROUTER,
    ),
    "openrouter-deepseek-chat-v2": _preset(
        config=OPENROUTER_DEEPSEEK_CHAT_V2,
        label="DeepSeek Chat V2 (OpenRouter)",
        description="DeepSeek Chat V2 model via OpenRouter.",
        provider=ModelProvider.OPENROUTER,
    ),
    "zai-glm4": _preset(
        config=ZAI_GLM4,

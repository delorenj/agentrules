"""ZAI provider implementation of ``BaseArchitect``."""
...
class ZaiArchitect(BaseArchitect):
    """Architect implementation backed by ZAI's OpenAI-compatible API."""
